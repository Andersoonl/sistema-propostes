...
export const entitySchema = z.object({
  companyName: z
    .string()
    .min(2, 'Razao social deve ter no minimo 2 caracteres')
    .max(200, 'Razao social deve ter no maximo 200 caracteres'),
...
export type EntityParsed = z.output<typeof entitySchema>

// Re-exports para compatibilidade
export { entitySchema as customerSchema, entitySchema as supplierSchema }
export type { EntityInput as CustomerInput, EntityInput as SupplierInput }
