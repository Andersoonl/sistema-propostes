...
export async function getCustomerCounts(): Promise<EntityCounts> {
...
export async function createCustomer(data: CustomerInput) {
  ...
  if (existing) {
    throw new Error(`Já existe um cliente com este ${documentType}`)
  }
...
export async function updateCustomer(id: string, data: CustomerInput) {
  ...
  if (existing && existing.id !== id) {
    throw new Error(`Já existe outro cliente com este ${documentType}`)
  }
